...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/typeof.js
function _typeof(o) {
...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/toPrimitive.js
...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/toPropertyKey.js
function toPropertyKey(t) {
  var i = toPrimitive(t, "string");
  return "symbol" == _typeof(i) ? i : i + "";
}

// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/defineProperty.js
...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/extends.js
function _extends() {
...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/objectSpread2.js
...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/arrayWithHoles.js
function _arrayWithHoles(r) {
  if (Array.isArray(r)) return r;
}

// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/iterableToArrayLimit.js
...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js
...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/unsupportedIterableToArray.js
...
// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/nonIterableRest.js
function _nonIterableRest() {
  throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
}

// node_modules/rc-pagination/node_modules/@babel/runtime/helpers/esm/slicedToArray.js
...
function useSafeState(defaultValue) {
  ...
  var _React$useState = React3.useState(defaultValue), _React$useState2 = _slicedToArray2(_React$useState, 2), value = _React$useState2[0], setValue = _React$useState2[1];
...
function pickAttrs(props) {
  ...
  if (ariaOnly === false) {
    ...
    mergedConfig = _objectSpread22({}, ariaOnly);
  }
  var attrs = {};
...
var Options = function Options2(props) {
  var _props$pageSizeOption = props.pageSizeOptions, pageSizeOptions = _props$pageSizeOption === void 0 ? defaultPageSizeOptions : _props$pageSizeOption, locale2 = props.locale, changeSize = props.changeSize, pageSize = props.pageSize, goButton = props.goButton, quickGo = props.quickGo, rootPrefixCls = props.rootPrefixCls, Select = props.selectComponentClass, selectPrefixCls = props.selectPrefixCls, disabled = props.disabled, buildOptionText = props.buildOptionText;
  var _React$useState = import_react.default.useState(""), _React$useState2 = _slicedToArray(_React$useState, 2), goInputText = _React$useState2[0], setGoInputText = _React$useState2[1];
  ...
  if (quickGo) {
    if (goButton) {
      ...
      }, locale2.jump_to_confirm) : import_react.default.createElement("span", {
        onClick: go,
        onKeyUp: go
      }, goButton);
    }
    ...
    }, locale2.jump_to, import_react.default.createElement("input", {
      disabled,
      type: "text",
      value: goInputText,
...
var Pager = function Pager2(props) {
  ...
  var cls = (0, import_classnames.default)(prefixCls, "".concat(prefixCls, "-").concat(page), (_classNames = {}, _defineProperty2(_classNames, "".concat(prefixCls, "-active"), active), _defineProperty2(_classNames, "".concat(prefixCls, "-disabled"), !page), _classNames), className);
  ...
  return pager ? import_react2.default.createElement("li", {
...
var Pagination = function Pagination2(props) {
  ...
  var paginationRef = import_react3.default.useRef(null);
  ...
  var _React$useState = import_react3.default.useState(current), _React$useState2 = _slicedToArray(_React$useState, 2), internalInputVal = _React$useState2[0], setInternalInputVal = _React$useState2[1];
  ...
  function getItemIcon(icon, label) {
    ...
    if (typeof icon === "function") {
      iconNode = import_react3.default.createElement(icon, _objectSpread2({}, props));
    }
    return iconNode;
  }
  ...
  function renderPrev(prevPage2) {
    ...
    return import_react3.default.isValidElement(prevButton) ? import_react3.default.cloneElement(prevButton, {
      disabled: !hasPrev
    }) : prevButton;
  }
  function renderNext(nextPage2) {
    var nextButton = itemRender(nextPage2, "next", getItemIcon(nextIcon, "next page"));
    return import_react3.default.isValidElement(nextButton) ? import_react3.default.cloneElement(nextButton, {
      disabled: !hasNext
    }) : nextButton;
  }
  ...
  if (simple) {
    ...
    simplePager = import_react3.default.createElement("li", {
      title: showTitle ? "".concat(current, "/").concat(allPages) : null,
      className: "".concat(prefixCls, "-simple-pager")
    }, isReadOnly ? internalInputVal : import_react3.default.createElement("input", {
      type: "text",
      value: internalInputVal,
      disabled,
  ...
  if (allPages <= 3 + pageBufferSize * 2) {
    ...
    if (showPrevNextJumpers) {
      jumpPrev = jumpPrevContent ? import_react3.default.createElement("li", {
        ...
        className: (0, import_classnames2.default)("".concat(prefixCls, "-jump-prev"), _defineProperty2({}, "".concat(prefixCls, "-jump-prev-custom-icon"), !!jumpPrevIcon))
      ...
      jumpNext = jumpNextContent ? import_react3.default.createElement("li", {
        ...
        className: (0, import_classnames2.default)("".concat(prefixCls, "-jump-next"), _defineProperty2({}, "".concat(prefixCls, "-jump-next-custom-icon"), !!jumpNextIcon))
    ...
    if (current - 1 >= pageBufferSize * 2 && current !== 1 + 2) {
      pagerList[0] = import_react3.default.cloneElement(pagerList[0], {
        className: (0, import_classnames2.default)("".concat(prefixCls, "-item-after-jump-prev"), pagerList[0].props.className)
      });
      pagerList.unshift(jumpPrev);
    }
    if (allPages - current >= pageBufferSize * 2 && current !== allPages - 2) {
      var lastOne = pagerList[pagerList.length - 1];
      pagerList[pagerList.length - 1] = import_react3.default.cloneElement(lastOne, {
        className: (0, import_classnames2.default)("".concat(prefixCls, "-item-before-jump-next"), lastOne.props.className)
      });
      pagerList.push(jumpNext);
    }
    if (left !== 1) {
      pagerList.unshift(import_react3.default.createElement(Pager_default, _extends({}, pagerProps, {
        key: 1,
        page: 1
      })));
    }
  ...
  if (prev) {
    ...
    prev = import_react3.default.createElement("li", {
      title: showTitle ? locale2.prev_page : null,
      onClick: prevHandle,
      tabIndex: prevDisabled ? null : 0,
      onKeyDown: runIfEnterPrev,
      className: (0, import_classnames2.default)("".concat(prefixCls, "-prev"), _defineProperty2({}, "".concat(prefixCls, "-disabled"), prevDisabled)),
  ...
  if (next) {
    ...
    next = import_react3.default.createElement("li", {
      title: showTitle ? locale2.next_page : null,
      onClick: nextHandle,
      tabIndex: nextTabIndex,
      onKeyDown: runIfEnterNext,
      className: (0, import_classnames2.default)("".concat(prefixCls, "-next"), _defineProperty2({}, "".concat(prefixCls, "-disabled"), nextDisabled)),
      "aria-disabled": nextDisabled
    }, next);
  }
  var cls = (0, import_classnames2.default)(prefixCls, className, (_classNames5 = {}, _defineProperty2(_classNames5, "".concat(prefixCls, "-start"), align === "start"), _defineProperty2(_classNames5, "".concat(prefixCls, "-center"), align === "center"), _defineProperty2(_classNames5, "".concat(prefixCls, "-end"), align === "end"), _defineProperty2(_classNames5, "".concat(prefixCls, "-simple"), simple), _defineProperty2(_classNames5, "".concat(prefixCls, "-disabled"), disabled), _classNames5));
  return import_react3.default.createElement("ul", _extends({
    className: cls,
    style,
    ref: paginationRef
  }, dataOrAriaAttributeProps), totalText, prev, simple ? simplePager : pagerList, next, import_react3.default.createElement(Options_default, {
    locale: locale2,
    rootPrefixCls: prefixCls,
    disabled,
